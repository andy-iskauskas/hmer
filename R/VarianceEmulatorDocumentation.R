# ----------------------
# Variance Emulator Documentation
# ----------------------
...
#'    the derviative of the emulated function, Var[f'(x)]. The arguments are similar to
...
#'    Linear adjustment, allowing for the requisite predicitions to be made using
