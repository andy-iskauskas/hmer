...
#> [1] "15 initial valid points generated for I=8.86"
#> [1] "Performing line sampling..."
#> [1] "Line sampling generated 40 more points."
#> [1] "Performing importance sampling..."
#> [1] "Importance sampling generated 110 more points."
#> [1] "14 initial valid points generated for I=4.676"
#> [1] "Performing line sampling..."
#> [1] "Line sampling generated 40 more points."
#> [1] "Performing importance sampling..."
#> [1] "Importance sampling generated 85 more points."
#> [1] "Point proposal seems to be asymptoting around implausibility 3.643 - terminating."
#> [1] "Target nS consistently underestimated."
#> [1] "Target nI consistently underestimated."
```

![plot of chunk bad_design_generation](handbook-bad_design_generation-1.png)

```
#> [1] "Inspect implausibility boxplot for problematic outputs, and consider transforming them or removing them from this wave."
#> [1] "Resample 1"
#> [1] "Performing line sampling..."
#> [1] "Line sampling generated 40 more points."
#> [1] "Performing importance sampling..."
...
#> [1] "Target output5 consistently overestimated."
#> [1] "Target output7 consistently overestimated."
#> [1] "Target output9 consistently overestimated."
#> [1] "Target output10 consistently overestimated."
#> [1] "Target output15 consistently overestimated."
#> [1] "Target output18 consistently overestimated."
#> [1] "Some outputs may not be adequately emulated, due to consistent over/underestimation in training data."
#> [1] "Consider looking at the outputs (using, eg, behaviour_plot); some outputs may require extra runs and/or transformation."
#> [1] "Fewer than 210 non-NA points in 21 dimensions - treat the emulated outputs with caution, or include more training points (minimum 10 times the number of input parameters)."
#> [1] "Fitting regression surfaces..."
#> [1] "Building correlation structures.."
#> [1] "Creating emulators..."
#> [1] "Performing Bayes linear adjustment..."
