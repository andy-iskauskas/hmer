...
#> [1] "Separated dataset by unique points..."
#> [1] "Computed summary statistics..."
#> [1] "Completed variance emulators. Training mean emulators..."
...
#> [1] "122 initial valid points generated for I=3"
...
#> [1] "Separated dataset by unique points."
#> [1] "Training emulator to proportion in modes."
#> [1] "Performing clustering to identify modes."
#> [1] "No targets appear to be unimodal."
#> [1] "Training to bimodal targets."
#> [1] "Trained emulators. Collating."
names(bim_ems)
#> [1] "mode1" "mode2" "prop"
```
