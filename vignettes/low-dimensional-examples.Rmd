...
#>  [1] -5.911938e-15 -7.882583e-15 -2.187139e-14 -4.374279e-14 -5.573320e-14 -3.552714e-14 -1.160183e-14
...
#> Proposing from LHS...
#> Error in if (nrow(points) >= n_points && this_cutoff == cutoff) {: missing value where TRUE/FALSE needed
```
...
#> Error in data.frame(x = plot1d$x, f = plot1d$f, E = em1d_2$f$get_exp(test1d), : object 'em1d_2' not found
...
#> 	 Regression Surface Expectation:  1.6662; 2.2919; -1.2793; 1.0627; -0.5933 
#> 	 Regression surface Variance (eigenvalues):  0; 0; 0; 0; 0 
#> Correlation Structure: 
#> Bayes-adjusted emulator - prior specifications listed. 
#> 	 Variance (Representative):  0.1180152 
#> 	 Expectation:  0 
#> 	 Correlation type: exp_sq 
#> 	 Hyperparameters:  theta: 0.6092 
#> 	 Nugget term: 0 
...
#> 	 Active variables x; y 
#> 	 Regression Surface Expectation:  -3.3327; -0.0339; -0.0168; 0.7681; 1.4086; 1.3461 
#> 	 Regression surface Variance (eigenvalues):  0; 0; 0; 0; 0; 0 
#> Correlation Structure: 
#> Bayes-adjusted emulator - prior specifications listed. 
#> 	 Variance (Representative):  0.09065997 
#> 	 Expectation:  0 
#> 	 Correlation type: exp_sq 
#> 	 Hyperparameters:  theta: 0.532 
#> 	 Nugget term: 0 
...
#> 	 Basis functions:  (Intercept); x; y; I(x^2); I(y^2) 
#> 	 Active variables x; y 
#> 	 Regression Surface Expectation:  0.845; 1.2474; -1.2732; 1.3337; -0.8123 
#> 	 Regression surface Variance (eigenvalues):  0; 0; 0; 0; 0 
#> Correlation Structure: 
#> Bayes-adjusted emulator - prior specifications listed. 
#> 	 Variance (Representative):  0.05717792 
#> 	 Expectation:  0 
#> 	 Correlation type: exp_sq 
...
#> 	 Basis functions:  (Intercept) 
#> 	 Active variables x; y 
#> 	 Regression Surface Expectation:  -2.9536 
#> 	 Regression surface Variance (eigenvalues):  0 
#> Correlation Structure: 
#> Bayes-adjusted emulator - prior specifications listed. 
#> 	 Variance (Representative):  0.03691688 
#> 	 Expectation:  0 
#> 	 Correlation type: exp_sq 
#> 	 Hyperparameters:  theta: 1 
#> 	 Nugget term: 0.05 
