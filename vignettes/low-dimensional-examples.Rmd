...
Again, in a normal circumstance we would investigate these plots and points that fail diagnostics, making changes to the emulators as required. We briefly look at the implausibilities for these new emulators:
