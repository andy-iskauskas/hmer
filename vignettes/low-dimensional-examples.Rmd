...
```{r fig.width = 7, fig.height = 7}
inflated_em <- ems2d$f2$set_sigma(function(x) 2 * ems2d$f2$u_sigma(x))
new_invaliid <- validation_diagnostics(list(f1 = ems2d$f1, f2 = inflated_em), targets2d, validation_data)
```
