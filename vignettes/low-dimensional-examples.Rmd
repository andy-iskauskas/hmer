...
#> Error in apply(x, 1, function(y) y - centers): dim(X) must have a positive length
em1d
#> Error in eval(expr, envir, enclos): object 'em1d' not found
```
...
#> Error in data.frame(x = test1d$x, f = func(test1d$x), E = em1d_exp, max = em1d_exp + : object 'em1d_exp' not found
plot(data = plot1d, f ~ x, ylim = c(min(plot1d[,-1]), max(plot1d[-1])),
     type = 'l', main = "Emulation of a Simple 1d Function", xlab = "x", ylab = "f(x)")
#> Error in eval(m$data, eframe): object 'plot1d' not found
...
#> Error in "Emulator" %in% class(emulators): object 'em1d' not found
```
...
#> Error in purrr::map_chr(imps, col_func, max(imps)): object 'imps' not found
...
#> Error in unlist(new_points1d, use.names = F): object 'new_points1d' not found
points(plot1d$x, rep(min(plot1d[,-1])-0.5, length(plot1d$x)), col = col.pal, pch = 16)
#> Error in points(plot1d$x, rep(min(plot1d[, -1]) - 0.5, length(plot1d$x)), : object 'plot1d' not found
...
#> Error in nrow(input_data): object 'new_data1d' not found
...
#> Error in data.frame(x = plot1d$x, f = plot1d$f, E = em1d_2$f$get_exp(test1d), : object 'plot1d' not found
...
#> Error in eval(m$data, eframe): object 'plot1d_2' not found
...
#> Error in eval(m$data, eframe): object 'new_data1d' not found
...
#> Error in "Emulator" %in% class(emulators): object 'em1d_2' not found
...
#> Error in unlist(new_new_points1d, use.names = F): object 'new_new_points1d' not found
```
...
#> 	 Active variables x; y 
#> 	 Regression Surface Expectation:  -3.4548; -0.0501; -0.1122; 1.2372; 1.4433; 1.2204 
#> 	 Regression surface Variance (eigenvalues):  0; 0; 0; 0; 0; 0 
#> Correlation Structure: 
#> Bayes-adjusted emulator - prior specifications listed. 
#> 	 Variance (Representative):  0.1531353 
#> 	 Expectation:  0 
#> 	 Correlation type: exp_sq 
#> 	 Hyperparameters:  theta: 0.5926 
#> 	 Nugget term: 0 
...
#> Proposing from LHS...
#> 99 initial valid points generated for I=3
...
#> 	 Basis functions:  (Intercept); x; y; I(x^2); I(y^2) 
#> 	 Active variables x; y 
#> 	 Regression Surface Expectation:  0.8212; 1.2353; -1.2765; 1.41; -0.7104 
#> 	 Regression surface Variance (eigenvalues):  0; 0; 0; 0; 0 
#> Correlation Structure: 
#> Bayes-adjusted emulator - prior specifications listed. 
#> 	 Variance (Representative):  0.0607278 
#> 	 Expectation:  0 
#> 	 Correlation type: exp_sq 
...
#> Parameters and ranges:  x: c(-1.5708, 0.6): y: c(-1, 1) 
#> Specifications: 
#> 	 Basis functions:  (Intercept); x; y; I(y^2); x:y 
#> 	 Active variables x; y 
#> 	 Regression Surface Expectation:  -3.0016; -0.016; -0.5749; 0.0588; 1.2553 
#> 	 Regression surface Variance (eigenvalues):  0; 0; 0; 0; 0 
#> Correlation Structure: 
#> Bayes-adjusted emulator - prior specifications listed. 
#> 	 Variance (Representative):  0.003947063 
#> 	 Expectation:  0 
#> 	 Correlation type: exp_sq 
#> 	 Hyperparameters:  theta: 0.5051 
#> 	 Nugget term: 0 
#> Mixed covariance:  0 0 0 0 0
```
...
#> Warning in arrows(x0 = output_points[[i]], y0 = in_data$exp[[i]] - in_data$unc[[i]], : zero-length arrow is of indeterminate
...
#> Proposing from LHS...
#> 140 initial valid points generated for I=3
#> Selecting final points using maximin criterion...
